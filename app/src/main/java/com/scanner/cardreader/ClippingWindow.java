...
//        setFocusableInTouchMode(false);
    ...
    public void drawCircle(Canvas canvas)
    {
        ...
        canvas.drawCircle((left+right)/2,top,5,drawCircle);
        //canvas.drawCircle(right,top,20,drawCircle);

        //circle points on the bottom
        //canvas.drawCircle(left,bottom,20,drawCircle);
        canvas.drawCircle((left+right)/2,bottom,5,drawCircle);
        //canvas.drawCircle(right,bottom,20,drawCircle);

        //circle on left
        canvas.drawCircle(left,(top+bottom)/2, 5, drawCircle);
        canvas.drawCircle(right,(top+bottom)/2, 5, drawCircle);
